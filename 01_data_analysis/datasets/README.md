...
- Demonstrate skills in data cleaning, transformation, and visualization
- Provide realistic examples for exploratory data analysis.
- Support reproducible projects where others can download and explore the same data.
...
- All datasets are publicly available and governed by their original licenses.  
- Data is used for non-commercial, educational, and illustrative purposes.  
- When required, original dataset links and author credits are listed above.  
